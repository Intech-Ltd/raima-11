...
/* ----------------------------------------------------------------------------
   options for SQLSetConnectAttr/SQLGetConnectAttr
*/
...
/* ----------------------------------------------------------------------------
   SQLColAttributes and SQLGetInfo subdefines for SQL_COLUMN_SEARCHABLE
*/
...
/* ----------------------------------------------------------------------------
   SQLGetFunctions: additional values for fFunction to represent functions
   that are not in the X/Open spec.
*/
...
/* ----------------------------------------------------------------------------
   ODBC 3.0 SQLGetInfo values that are not part of the X/Open standard at this
   time.  X/Open standard values are in sql.h.
*/
...
/* ----------------------------------------------------------------------------
   bitmasks for SQL_DYNAMIC_CURSOR_ATTRIBUTES1,
                ...
                SQL_KEYSET_CURSOR_ATTRIBUTES1, and
...
/* ----------------------------------------------------------------------------
   bitmasks for SQL_DYNAMIC_CURSOR_ATTRIBUTES2,
                ...
                SQL_KEYSET_CURSOR_ATTRIBUTES2, and
...
/* ============================================================================
   Unicode defines below are stored in "sqlucode.h" in Microsoft ODBC
*/
#if !defined(RDM_NO_UNICODE)
