...
----------------------------------------------------------------*/
database timserver {
    data file "timserver.d01" contains system, key_word, intersect;
    data file "timserver.d02" contains author, borrower, info, infotext;
    vardata file "timserver.v01" contains info_title;
    vardata file "timserver.v02" contains id_code;
    key  file "timserver.k01" contains id_code;
    key  file "timserver.k02" contains frnd, kword;
