...
database songs_pk inmemory {
    ...
    record album {
        key[2] varchar album_name[45];
    }

    record artist {
        key[2] char artist_name[25];
    }

    record genre {
        key[2] char genre_name[25];
    }

    record track {
        key[2] varchar track_name[45];
        unique key[2] char track_id[8];
        int16_t track_year;
    }
