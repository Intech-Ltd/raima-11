...
**        ddlp -d -c optional_key.ddl
**
**    Please refer to the Database Design section in the User Manual for details of RDM Database schema.
*/
database optional_key
{
  data file "optional_key.d01" contains info;
  key file "optional_key.k01" contains myChar;

  record info
  {
    optional key char myChar[32];
  }
}
