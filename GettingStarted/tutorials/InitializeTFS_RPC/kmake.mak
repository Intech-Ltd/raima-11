...
#include "InitializeTFS_RPC.dp"

$#DATABASE{name=initRPC_db, carray=1}


all: initRPC_db.h initRPC_Tutorial 

initRPC_Tutorial: odir $OinitRPC_Tutorial$e
...
$#MKEXE{prog=initRPC_Tutorial, objs= $(OBJS) initRPC_Tutorial_main$o, libs=$(EXE_LIBS)}
