...
var SHA_DATASIZE        = 16;
var SHA_DIGESTSIZE      = 20;
var SHA_BLOCKSIZE       = 64;
var RIJNDAEL_BLOCKSIZE  = 16;
var RIJNDAEL_KEYSIZE    = 16;
var KEYLEN              = 128;
...
/* =======================================================================
*/
function Make32BitNumber(d0, d1, d2, d3)
{
    return parseInt(d0 << 24) | parseInt(d1 << 16) |
                parseInt(d2 << 8) | parseInt(d3);
}
...
function EXPAND(W, t)
{
    return ROTL((W[t - 3] ^ W[t - 8] ^ W[t - 14] ^ W[t - 16]), 1);
}

/* =======================================================================
     The four SHS sub-rounds
*/
function SUBROUND(r, t, d, W)
{
    var temp = ROTL(d[0], 5) + f[r-1](d[1],d[2],d[3]) + d[4] + W[t] + K[r-1];
    d[4] = d[3];
    d[3] = d[2];
    d[2] = ROTR(d[1], 2);
    d[1] = d[0];
...
/* ======================================================================
   Apply the transform to the digest
*/
function transform(data, digest)
{
    var W = new Array(80);
    var d = new Array(5);
    var ii;
    ...
    for (ii = 0, jj = 0; ii < SHA_DATASIZE; ii++, jj += 4)
    {
        /* convert to uint32 type */
        W[ii] = Make32BitNumber(data[jj], data[jj+1], data[jj+2], data[jj+3]);
    }

    /* Step B. Expand the 16 uints into 64 temporary data uints */
    W[16] = EXPAND(W,16); W[17] = EXPAND(W,17); W[18] = EXPAND(W,18);
    W[19] = EXPAND(W,19); W[20] = EXPAND(W,20); W[21] = EXPAND(W,21);
    W[22] = EXPAND(W,22); W[23] = EXPAND(W,23); W[24] = EXPAND(W,24);
    W[25] = EXPAND(W,25); W[26] = EXPAND(W,26); W[27] = EXPAND(W,27);
    W[28] = EXPAND(W,28); W[29] = EXPAND(W,29); W[30] = EXPAND(W,30);
    W[31] = EXPAND(W,31); W[32] = EXPAND(W,32); W[33] = EXPAND(W,33);
    W[34] = EXPAND(W,34); W[35] = EXPAND(W,35); W[36] = EXPAND(W,36);
    W[37] = EXPAND(W,37); W[38] = EXPAND(W,38); W[39] = EXPAND(W,39);
    W[40] = EXPAND(W,40); W[41] = EXPAND(W,41); W[42] = EXPAND(W,42);
    W[43] = EXPAND(W,43); W[44] = EXPAND(W,44); W[45] = EXPAND(W,45);
    W[46] = EXPAND(W,46); W[47] = EXPAND(W,47); W[48] = EXPAND(W,48);
    W[49] = EXPAND(W,49); W[50] = EXPAND(W,50); W[51] = EXPAND(W,51);
    W[52] = EXPAND(W,52); W[53] = EXPAND(W,53); W[54] = EXPAND(W,54);
    W[55] = EXPAND(W,55); W[56] = EXPAND(W,56); W[57] = EXPAND(W,57);
    W[58] = EXPAND(W,58); W[59] = EXPAND(W,59); W[60] = EXPAND(W,60);
    W[61] = EXPAND(W,61); W[62] = EXPAND(W,62); W[63] = EXPAND(W,63);
    W[64] = EXPAND(W,64); W[65] = EXPAND(W,65); W[66] = EXPAND(W,66);
    W[67] = EXPAND(W,67); W[68] = EXPAND(W,68); W[69] = EXPAND(W,69);
    W[70] = EXPAND(W,70); W[71] = EXPAND(W,71); W[72] = EXPAND(W,72);
    W[73] = EXPAND(W,73); W[74] = EXPAND(W,74); W[75] = EXPAND(W,75);
    W[76] = EXPAND(W,76); W[77] = EXPAND(W,77); W[78] = EXPAND(W,78);
    W[79] = EXPAND(W,79);
    ...
    SUBROUND(1,0,d,W);  SUBROUND(1,1,d,W);  SUBROUND(1,2,d,W);  SUBROUND(1,3,d,W);
    SUBROUND(1,4,d,W);  SUBROUND(1,5,d,W);  SUBROUND(1,6,d,W);  SUBROUND(1,7,d,W);
    SUBROUND(1,8,d,W);  SUBROUND(1,9,d,W);  SUBROUND(1,10,d,W); SUBROUND(1,11,d,W);
    SUBROUND(1,12,d,W); SUBROUND(1,13,d,W); SUBROUND(1,14,d,W); SUBROUND(1,15,d,W);
    SUBROUND(1,16,d,W); SUBROUND(1,17,d,W); SUBROUND(1,18,d,W); SUBROUND(1,19,d,W);

    SUBROUND(2,20,d,W); SUBROUND(2,21,d,W); SUBROUND(2,22,d,W); SUBROUND(2,23,d,W);
    SUBROUND(2,24,d,W); SUBROUND(2,25,d,W); SUBROUND(2,26,d,W); SUBROUND(2,27,d,W);
    SUBROUND(2,28,d,W); SUBROUND(2,29,d,W); SUBROUND(2,30,d,W); SUBROUND(2,31,d,W);
    SUBROUND(2,32,d,W); SUBROUND(2,33,d,W); SUBROUND(2,34,d,W); SUBROUND(2,35,d,W);
    SUBROUND(2,36,d,W); SUBROUND(2,37,d,W); SUBROUND(2,38,d,W); SUBROUND(2,39,d,W);

    SUBROUND(3,40,d,W); SUBROUND(3,41,d,W); SUBROUND(3,42,d,W); SUBROUND(3,43,d,W);
    SUBROUND(3,44,d,W); SUBROUND(3,45,d,W); SUBROUND(3,46,d,W); SUBROUND(3,47,d,W);
    SUBROUND(3,48,d,W); SUBROUND(3,49,d,W); SUBROUND(3,50,d,W); SUBROUND(3,51,d,W);
    SUBROUND(3,52,d,W); SUBROUND(3,53,d,W); SUBROUND(3,54,d,W); SUBROUND(3,55,d,W);
    SUBROUND(3,56,d,W); SUBROUND(3,57,d,W); SUBROUND(3,58,d,W); SUBROUND(3,59,d,W);

    SUBROUND(4,60,d,W); SUBROUND(4,61,d,W); SUBROUND(4,62,d,W); SUBROUND(4,63,d,W);
    SUBROUND(4,64,d,W); SUBROUND(4,65,d,W); SUBROUND(4,66,d,W); SUBROUND(4,67,d,W);
    SUBROUND(4,68,d,W); SUBROUND(4,69,d,W); SUBROUND(4,70,d,W); SUBROUND(4,71,d,W);
    SUBROUND(4,72,d,W); SUBROUND(4,73,d,W); SUBROUND(4,74,d,W); SUBROUND(4,75,d,W);
    SUBROUND(4,76,d,W); SUBROUND(4,77,d,W); SUBROUND(4,78,d,W); SUBROUND(4,79,d,W);
...
/* ======================================================================
   Encrypt the message into the digest using SHA-1
   'buffer' is a string
   'count' is length of 'buffer'
   Returns 'digest', which is an array[20] of uint8_t
*/
function sha_encrypt(buffer, count)
{
    var data = new Array(SHA_BLOCKSIZE);
    var digest;
    var result = new Array(SHA_DIGESTSIZE);
    var org_bits = count * 8;
    var buflen = count;
    var ii;
    var jj;

    digest = hinit.slice(0);
    for (ii = 0; ii < buflen && count >= SHA_BLOCKSIZE; ii += SHA_BLOCKSIZE)
    {
        /* copy block's bytes to 'data' */
        for (jj = 0; jj < SHA_BLOCKSIZE; ++jj)
            data[jj] = buffer.charCodeAt(jj + ii);
        transform(data, digest);
        count -= SHA_BLOCKSIZE;
    }

    /* copy block's bytes to 'data' */
    for (ii = 0; ii < count; ++ii)
        data[ii] = buffer.charCodeAt(buflen - count + ii);

    data[count++] = 0x80;

    if (count > 56)
    {
        for (ii = count; ii < SHA_BLOCKSIZE; ++ii)
            data[ii] = 0;
        transform(data, digest);
        count = 0;
    }

    for (ii = count; ii < 56; ++ii)
        data[ii] = 0;

    data[56] = data[57] = data[58] = data[59] = 0;
    data[60] = (org_bits >>> 24) & 0xff;
    data[61] = (org_bits >>> 16) & 0xff;
    data[62] = (org_bits >>> 8) & 0xff;
    data[63] = org_bits & 0xff;

    transform(data, digest);

    /* Return result as array of bytes converting from array of uint32 */
    for (ii = 0, jj = 0; ii < digest.length; ++ii)
    {
        result[jj++] = (digest[ii] >>> 24) & 0xff;
        result[jj++] = (digest[ii] >>> 16) & 0xff;
        result[jj++] = (digest[ii] >>> 8) & 0xff;
        result[jj++] = digest[ii] & 0xff;
    }
...
/* =======================================================================
*/
function b0(x) { return ((x) >>> 24) & 0xff; }
function b1(x) { return ((x) >>> 16) & 0xff; }
function b2(x) { return ((x) >>> 8) & 0xff; }
function b3(x) { return  (x) & 0xff; }

/* =======================================================================
    Rijndael context block object.

    var rcb = new rijndaeldb();
*/
function rijndaelcb()
{
    this.rkenc = new Array(11);
    for (var ii = 0; ii < 11; ++ii)
        this.rkenc[ii] = new Array(4);

    this.rkdec = new Array(11);
    for (var ii = 0; ii < 11; ++ii)
        this.rkdec[ii] = new Array(4);
}


/* ======================================================================
   Set the key for the Rijndael encryption/decryption.
   'key' is an array of 20 bytes.
*/
function rijndael_setKey(rcb, key)
{
    var j;
    var r;
    var t;
    ...
    /* Local copy of key's first 16 bytes */
    ...
    do
    {
        for ( ; j < 4 && t < 4; j++, t++)
        {
            rcb.rkenc[r][t] = Make32BitNumber(tk[j][0], tk[j][1], tk[j][2],
                                                tk[j][3]);
        }
    ...
    for (t = 0; t < 4; t++)
    {
        rcb.rkdec[0][t] = rcb.rkenc[0][t];
        rcb.rkdec[10][t] = rcb.rkenc[10][t];
    }
    ...
    for (r = 1; r < 10; r++)
    {
        for (t = 0; t < 4; t++)
        {
            rcb.rkdec[r][t] = U1[b0(rcb.rkenc[r][t])] ^
                    U2[b1(rcb.rkenc[r][t])] ^
                    U3[b2(rcb.rkenc[r][t])] ^
                    U4[b3(rcb.rkenc[r][t])];
        }
...
/* =======================================================================
*/
function ENCRYPT_ROUND(rcb, r, d)
{
    var t0;
    var t1;
    var t2;
    ...
    t0 = d[0] ^ rcb.rkenc[r][0];
    t1 = d[1] ^ rcb.rkenc[r][1];
    t2 = d[2] ^ rcb.rkenc[r][2];
    t3 = d[3] ^ rcb.rkenc[r][3];
    d[0] = T1[b0(t0)] ^ T2[b1(t1)] ^ T3[b2(t2)] ^ T4[b3(t3)];
    d[1] = T1[b0(t1)] ^ T2[b1(t2)] ^ T3[b2(t3)] ^ T4[b3(t0)];
    d[2] = T1[b0(t2)] ^ T2[b1(t3)] ^ T3[b2(t0)] ^ T4[b3(t1)];
    d[3] = T1[b0(t3)] ^ T2[b1(t0)] ^ T3[b2(t1)] ^ T4[b3(t2)];
}

/* ======================================================================
   Encrypt a 16 byte chunk of 'data'.
   'data' is a string.
   'offset' is the starting point inside data, since rijndael only operates
   on 16 bytes at a time.
   Fills in 'result' with encrypted data as an array of uint8.
*/
function rijndael_encrypt(rcb, result, data, offset)
{
    var t0;
    var t1;
    var t2;
    ...
    d[0] = Make32BitNumber(data.charCodeAt(o+0), data.charCodeAt(o+1),
                           data.charCodeAt(o+2), data.charCodeAt(o+3));
    d[1] = Make32BitNumber(data.charCodeAt(o+4), data.charCodeAt(o+5),
                           data.charCodeAt(o+6), data.charCodeAt(o+7));
    d[2] = Make32BitNumber(data.charCodeAt(o+8), data.charCodeAt(o+9),
                           data.charCodeAt(o+10), data.charCodeAt(o+11));
    d[3] = Make32BitNumber(data.charCodeAt(o+12), data.charCodeAt(o+13),
                           data.charCodeAt(o+14), data.charCodeAt(o+15));

    /* Do rounds 0 through 8 */
    ENCRYPT_ROUND(rcb, 0, d);
    ENCRYPT_ROUND(rcb, 1, d);
    ENCRYPT_ROUND(rcb, 2, d);
    ENCRYPT_ROUND(rcb, 3, d);
    ENCRYPT_ROUND(rcb, 4, d);
    ENCRYPT_ROUND(rcb, 5, d);
    ENCRYPT_ROUND(rcb, 6, d);
    ENCRYPT_ROUND(rcb, 7, d);
    ENCRYPT_ROUND(rcb, 8, d);



    /* Do special round 9 */
    t0 = d[0] ^ rcb.rkenc[9][0];
    t1 = d[1] ^ rcb.rkenc[9][1];
    t2 = d[2] ^ rcb.rkenc[9][2];
    t3 = d[3] ^ rcb.rkenc[9][3];

    result[o+0] = (T1[b0(t0)] >>> 16) & 0xff;
    result[o+1] = (T1[b1(t1)] >>> 16) & 0xff;
    result[o+2] = (T1[b2(t2)] >>> 16) & 0xff;
    result[o+3] = (T1[b3(t3)] >>> 16) & 0xff;
    result[o+4] = (T1[b0(t1)] >>> 16) & 0xff;
    result[o+5] = (T1[b1(t2)] >>> 16) & 0xff;
    result[o+6] = (T1[b2(t3)] >>> 16) & 0xff;
    result[o+7] = (T1[b3(t0)] >>> 16) & 0xff;
    result[o+8] = (T1[b0(t2)] >>> 16) & 0xff;
    result[o+9] = (T1[b1(t3)] >>> 16) & 0xff;
    result[o+10] = (T1[b2(t0)] >>> 16) & 0xff;
    result[o+11] = (T1[b3(t1)] >>> 16) & 0xff;
    result[o+12] = (T1[b0(t3)] >>> 16) & 0xff;
    result[o+13] = (T1[b1(t0)] >>> 16) & 0xff;
    result[o+14] = (T1[b2(t1)] >>> 16) & 0xff;
    result[o+15] = (T1[b3(t2)] >>> 16) & 0xff;

    t0 = Make32BitNumber(result[o+0], result[o+1], result[o+2], result[o+3]);
    t1 = Make32BitNumber(result[o+4], result[o+5], result[o+6], result[o+7]);
    t2 = Make32BitNumber(result[o+8], result[o+9], result[o+10], result[o+11]);
    t3 = Make32BitNumber(result[o+12], result[o+13], result[o+14], result[o+15]);
    ...
    result[o+0] = (t0 >>> 24) & 0xff;
    result[o+1] = (t0 >>> 16) & 0xff;
    result[o+2] = (t0 >>> 8) & 0xff;
    result[o+3] =  t0 & 0xff;
    result[o+4] = (t1 >>> 24) & 0xff;
    result[o+5] = (t1 >>> 16) & 0xff;
    result[o+6] = (t1 >>> 8) & 0xff;
    result[o+7] =  t1 & 0xff;
    result[o+8] = (t2 >>> 24) & 0xff;
    result[o+9] = (t2 >>> 16) & 0xff;
    result[o+10] = (t2 >>> 8) & 0xff;
    result[o+11] =  t2 & 0xff;
    result[o+12] = (t3 >>> 24) & 0xff;
    result[o+13] = (t3 >>> 16) & 0xff;
    result[o+14] = (t3 >>> 8) & 0xff;
    result[o+15] =  t3 & 0xff;
}

/* =======================================================================
*/
function DECRYPT_ROUND(rcb, r, d)
{
    var t0;
    var t1;
    var t2;
    ...
    t0 = d[0] ^ rcb.rkdec[r][0];
    t1 = d[1] ^ rcb.rkdec[r][1];
    t2 = d[2] ^ rcb.rkdec[r][2];
    t3 = d[3] ^ rcb.rkdec[r][3];
    d[0] = T5[b0(t0)] ^ T6[b1(t3)] ^ T7[b2(t2)] ^ T8[b3(t1)];
    d[1] = T5[b0(t1)] ^ T6[b1(t0)] ^ T7[b2(t3)] ^ T8[b3(t2)];
    d[2] = T5[b0(t2)] ^ T6[b1(t1)] ^ T7[b2(t0)] ^ T8[b3(t3)];
    d[3] = T5[b0(t3)] ^ T6[b1(t2)] ^ T7[b2(t1)] ^ T8[b3(t0)];
}

/* ======================================================================
   Decrypt a 16 byte chunk of 'data'
   'offset' is the starting point inside data, since rijndael only operates
   on 16 bytes at a time.
   Overwrites 'data' with decrypted data as an array of uint8.
*/
function rijndael_decrypt(rcb, data, offset)
{
    var t0;
    var t1;
    var t2;
    ...
    d[0] = Make32BitNumber(data[o+0], data[o+1], data[o+2], data[o+3]);
    d[1] = Make32BitNumber(data[o+4], data[o+5], data[o+6], data[o+7]);
    d[2] = Make32BitNumber(data[o+8], data[o+9], data[o+10], data[o+11]);
    d[3] = Make32BitNumber(data[o+12], data[o+13], data[o+14], data[o+15]);

    DECRYPT_ROUND(rcb, 10, d);
    DECRYPT_ROUND(rcb, 9, d);
    DECRYPT_ROUND(rcb, 8, d);
    DECRYPT_ROUND(rcb, 7, d);
    DECRYPT_ROUND(rcb, 6, d);
    DECRYPT_ROUND(rcb, 5, d);
    DECRYPT_ROUND(rcb, 4, d);
    DECRYPT_ROUND(rcb, 3, d);
    DECRYPT_ROUND(rcb, 2, d);

    t0 = d[0] ^ rcb.rkdec[1][0];
    t1 = d[1] ^ rcb.rkdec[1][1];
    t2 = d[2] ^ rcb.rkdec[1][2];
    t3 = d[3] ^ rcb.rkdec[1][3];
    ...
    t0 = Make32BitNumber(data[o+0], data[o+1], data[o+2], data[o+3]);
    t1 = Make32BitNumber(data[o+4], data[o+5], data[o+6], data[o+7]);
    t2 = Make32BitNumber(data[o+8], data[o+9], data[o+10], data[o+11]);
    t3 = Make32BitNumber(data[o+12], data[o+13], data[o+14], data[o+15]);
    ...
    data[o+10] = (t2 >>> 8) & 0xff;
    data[o+11] =  t2 & 0xff;
    data[o+12] = (t3 >>> 24) & 0xff;
    data[o+13] = (t3 >>> 16) & 0xff;
    data[o+14] = (t3 >>> 8) & 0xff;
    data[o+15] =  t3 & 0xff;
}
...
/************************************************************************
  External calls to handle AES encryption/decryption.
************************************************************************/

/* =======================================================================
    Encryption context block object.

    var enc = new enccb();
*/
function enccb()
{
    this.blocksize = RIJNDAEL_BLOCKSIZE;
    this.aes = null;
...
/* ======================================================================
   Set up an encryption control block
   'key' is an array of 20 bytes or a string of 20 bytes.
*/
function enc_init(key)
{
    var enc = new enccb();
    var newkey = new Array();

    enc.aes = new rijndaelcb();

    if (typeof(key) == 'string')
    {
        /* If the input is a string, convert to an array */
        for (var ii = 0; ii < key.length; ++ii)
            newkey[ii] = key.charCodeAt(ii);
        key = newkey;
    }
    if (key.length < 20)
    {
        for (var ii = key.length-1; ii < SHA_DIGESTSIZE; ++ii)
            key[ii] = 0;
    }

    rijndael_setKey(enc.aes, key);

    /* Last 4 bytes of key */
    for (var ii = 0; ii < 4; ++ii)
        enc.key[ii] = key[RIJNDAEL_KEYSIZE + ii];

    for (var ii = 0; ii < 4; ++ii)
        enc.key[4 + ii] = key[4 * ii];

    return enc;
}

/* ======================================================================
   Encrypt data using information in the ENCCB
   'data' is a string
   Returned 'result' is an array of bytes, of size 'len'.
*/
function enc_encrypt(enc, data, len)
{
    var key;
    var ii;
    var result = new Array(len);

    for (ii = 0; len >= enc.blocksize; len -= enc.blocksize, ii += enc.blocksize)
        rijndael_encrypt(enc.aes, result, data, ii);

    if (len)
    {
        key = enc.key;
        for ( ; len; len--, ++ii)
            result[ii] = data.charCodeAt(ii) ^ key[len & 0x0007];
    }
...
/* ======================================================================
   Decrypt data using information in the ENCCB
   'data' is an array of bytes of size 'len'.
   Returned 'result' is a string.
*/
function enc_decrypt(enc, data, len)
{
    var key;
    var ii;
    var result = '';
    ...
    for (ii = 0; len >= enc.blocksize; len -= enc.blocksize, ii += enc.blocksize)
        rijndael_decrypt(enc.aes, data, ii);

    if (len)
    {
        key = enc.key;
        for ( ; len; len--, ++ii)
            data[ii] = data[ii] ^ key[len & 0x0007];
    }

    /* Convert decrypted array to a string */
    for (var ii = 0; ii < data.length; ++ii)
        result += String.fromCharCode(data[ii]);
